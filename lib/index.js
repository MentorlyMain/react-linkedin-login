...
var LinkedIn = (_class = (_temp = _class2 = function (_Component) {
  (0, _inherits3.default)(LinkedIn, _Component);
  ...
  (0, _createClass3.default)(LinkedIn, [{
    ...
    value: function start() {
      ...
      window.location.href = (0, _getURL2.default)({ clientId: clientId, state: state, scope: scope, redirectUri: redirectUri });
    }
  }, {
    key: 'restart',
    value: function restart() {
      ...
      if (!code || !state || state !== (0, _getQueryParameter2.default)('state')) {
        return;
      } else {
        (0, _reset2.default)();
